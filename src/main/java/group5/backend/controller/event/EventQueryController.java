...
<<<<<<< HEAD:src/main/java/group5/backend/controller/EventQueryController.java
...
=======
>>>>>>> origin/main:src/main/java/group5/backend/controller/event/EventQueryController.java
import group5.backend.dto.common.popup.response.PopupSummaryResponse;
import group5.backend.response.ApiResponse;
import group5.backend.service.event.EventQueryService;
